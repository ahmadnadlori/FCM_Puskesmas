...
class Pimpinan extends CI_Controller {
	...
	function index(){
		...
		if($sesinya['level'] != '2'){
			...
			$this->load->model('model');
			$data = array(
				'title'			=> 'Data Mining Metode Clustering Algoritma K-Means',
				'nama'			=> $sesinya['nama'],
	...
	function cetak_penyakit_view(){
		...
		$pdf->Write(0, 'Jl. Raya Lubuk Begalung, Kota Padang, Sumatera Barat, Indonesia', '', 0, 'C', true, 0, false, false, 0);
		$pdf->Write(0, 'Email : sourcecodekucom@gmail.com', '', 0, 'C', true, 0, false, false, 0);
		$pdf->Ln();
