<div class="container-fluid">
		  ...
		  <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-bell"></i> Data Proses Iterasi</h1>
			
				<a href="<?php echo base_url(); ?>supplier/iterasi_kmeans_lanjut"  class="btn btn-success">
                                <i class="fa fa-check"></i> Proses Iterasi Selanjutnya
                </a>
          </div>
		  ...
		  <div class="card shadow mb-4">
            ...
            ?>
			  ...
			  <th rowspan="2">Jumlah Pasien Total</th>
			  <th rowspan="2">Ketersedian Obat</th>
			  <th rowspan="2">Jumlah Fasilitas</th>
              <th colspan="3">Centroid 1</th>
			  <th colspan="3">Centroid 2</th>
			  <th colspan="3">Centroid 3</th>
			  <th rowspan="2" width="30">C1</th>
			  <th rowspan="2" width="30">C2</th>
			  <th rowspan="2" width="30">C3</th>
              </tr>
			  
              <tr align="center">
              <th><?php echo $c1a; ?></th><th><?php echo $c1b; ?></th><th><?php echo $c1c; ?></th>
              <th><?php echo $c2a; ?></th><th><?php echo $c2b; ?></th><th><?php echo $c2c; ?></th>
              <th><?php echo $c3a; ?></th><th><?php echo $c3b; ?></th><th><?php echo $c3c; ?></th>
              </tr>
			  </thead>
			  <tbody>
              <?php 
